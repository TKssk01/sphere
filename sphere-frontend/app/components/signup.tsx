...
const Signup = () => {
  ...
  const onSubmit: SubmitHandler<Schema> = async (data) => {
    ...
    try {
      ...
      if (errorSignup) {
        setMessage('サインアップエラー: ' + errorSignup.message)
        return
      }
      ...
      if (signUpData.user) {
        ...
        if (insertError) {
          setMessage('プロフィール登録エラー: ' + insertError.message)
          return
        }
...
// type ProfilesUpdate = Partial<Database['public']['Tables']['profiles']['Row']>
...
//         .from('profiles')
//         .update<ProfilesUpdate>({ name: data.name })
//         .eq('email', data.email)
